...
*[x] Employers should be able to see a listing of the jobs they have posted.
*[x] Jobseekers can save jobs onsite for later viewing.
*[x] Jobseekers can apply to jobs posted by employers.
    *[x] There are 2 different kinds of Jobs posted by employers: JReq and ATS. 
